...
# Dotplot Unmeasured(%) (TF family-Cell type), expressed TF across TF (stepminer)
source("/Users/saeko/Unmeasured/code/function/Dotplot_fam_ctc_unmeasured_rev1.R")
dotplot <- Dotplot_fam_ctc_unmeasured_rev1()
ggsave("/Users/saeko/Unmeasured/plot/Dotplot_fam_ctc_unmeasured_rev1.pdf", dotplot ,width = 15, height = 10)
...
# ChIP-Atlas existence ratio (bar plot), expressed TF across TF (stepminer)
source("/Users/saeko/Unmeasured/code/function/ChIP_Atlas_ctc_TF_bar_plot_rev1.R")
p_list <- ChIP_Atlas_ctc_TF_bar_plot_rev1()
ggsave("/Users/saeko/Unmeasured/plot/Unmeasured_number_CTC_bar_rev1.pdf", p_list[[1]], width = 9, height = 7)
...
# Number of publications/DEGs (violin plot, scatter plot), rev1 -----
source("/Users/saeko/Unmeasured/code/function/DEG_pub_violin_rev1.R")
p_list <- DEG_pub_violin_rev1()
ggsave("/Users/saeko/Unmeasured/plot/DEG_marker_plot_rev1/Number_of_DEG_violin_bwn_measure.pdf", p_list[[1]], width = 6, height = 9)
ggsave("/Users/saeko/Unmeasured/plot/DEG_marker_plot_rev1/Number_of_DEG_violin_bwn_marker.pdf", p_list[[2]], width = 6, height = 9)
ggsave("/Users/saeko/Unmeasured/plot/DEG_marker_plot_rev1/Scatte_pub_DEG_bwn_measure.pdf", p_list[[3]], width = 12, height = 9)
ggsave("/Users/saeko/Unmeasured/plot/DEG_marker_plot_rev1/Scatte_pub_DEG_filter_marker.pdf", p_list[[4]], width = 9, height = 9)
