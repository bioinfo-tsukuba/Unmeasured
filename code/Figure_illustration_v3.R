...
# Dotplot Unmeasured(%) (TF family-Cell type)
source("/Users/saeko/Unmeasured/code/function/Dotplot_fam_ctc_unmeasured.R")
calc_opt <- "FALSE"
tgt_threshold <- 0.75 #上位25%
tgt_threshold <- 0.50 #上位50%
dotplot <- Dotplot_fam_ctc_unmeasured(calc_opt, tgt_threshold)
ggsave(paste0("/Users/saeko/Unmeasured/plot/Dotplot_fam_ct_unmeasured_", tgt_threshold,".pdf"), dotplot ,width = 15, height = 10)
