pub_chip_plot_all <- function(){
  ...
  TF_list <- unique(Chip_df$Antigen)
  ...
  annotation3 <- annotation2 %>% filter(genome == "hg38") %>%distinct()
  dim(annotation3)
  ...
  write_tsv(df_join, "/Users/saeko/Unmeasured/data/pub_chip_plot_all_df_join.tsv")
