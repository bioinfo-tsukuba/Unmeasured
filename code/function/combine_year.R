combine_year <- function(tgt_ct, tgt_ct2, tgt_region){
  ...
  uniq_TF_df <- read_tsv(paste0("/Users/saeko/Unmeasured/data/uniqTF_table/", tgt_ct2, "_", tgt_region, "bp.tsv"))
  ...
  SRX_df <- read_tsv(paste0("/Users/saeko/Unmeasured/data/SRX_table/", tgt_ct2, "_", tgt_region, "bp.tsv"))
  ...
  pdf(file = paste0("/Users/saeko/Unmeasured/plot/combine_year/", tgt_ct2, "_", tgt_region, "bp.pdf" ), width = 5, height = 9)
  print(p1 / p2 / p3)
  dev.off()
